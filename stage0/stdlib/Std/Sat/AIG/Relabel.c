...
_start:
{
lean_object* v_decls_81_; lean_object* v___x_83_; uint8_t v_isShared_84_; uint8_t v_isSharedCheck_96_; 
v_decls_81_ = lean_ctor_get(v_aig_80_, 0);
v_isSharedCheck_96_ = !lean_is_exclusive(v_aig_80_);
if (v_isSharedCheck_96_ == 0)
{
lean_object* v_unused_97_; 
v_unused_97_ = lean_ctor_get(v_aig_80_, 1);
lean_dec(v_unused_97_);
v___x_83_ = v_aig_80_;
v_isShared_84_ = v_isSharedCheck_96_;
goto v_resetjp_82_;
}
else
{
...
v_resetjp_82_:
{
lean_object* v___f_85_; lean_object* v___x_86_; size_t v_sz_87_; size_t v___x_88_; lean_object* v___x_89_; lean_object* v___x_90_; lean_object* v_decls_91_; lean_object* v_cache_92_; lean_object* v___x_94_; 
...
v___x_89_ = l_unsafeCast___redArg(v_decls_81_);
lean_dec_ref(v_decls_81_);
v___x_90_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map(lean_box(0), lean_box(0), lean_box(0), v___x_86_, v___f_85_, v_sz_87_, v___x_88_, v___x_89_);
v_decls_91_ = l_unsafeCast___redArg(v___x_90_);
lean_dec(v___x_90_);
v_cache_92_ = lean_obj_once(&l_Std_Sat_AIG_relabel___redArg___closed__11, &l_Std_Sat_AIG_relabel___redArg___closed__11_once, _init_l_Std_Sat_AIG_relabel___redArg___closed__11);
if (v_isShared_84_ == 0)
{
lean_ctor_set(v___x_83_, 1, v_cache_92_);
lean_ctor_set(v___x_83_, 0, v_decls_91_);
v___x_94_ = v___x_83_;
goto v_reusejp_93_;
}
else
