...
static const lean_array_object l_Lean_Elab_Command_instInhabitedScope_default___closed__2_value = {.m_header = {.m_rc = 0, .m_cs_sz = sizeof(lean_array_object) + sizeof(void*)*0, .m_other = 0, .m_tag = 246}, .m_size = 0, .m_capacity = 0, .m_data = {}};
static const lean_object* l_Lean_Elab_Command_instInhabitedScope_default___closed__2 = (const lean_object*)&l_Lean_Elab_Command_instInhabitedScope_default___closed__2_value;
static lean_once_cell_t l_Lean_Elab_Command_instInhabitedScope_default___closed__3_once = LEAN_ONCE_CELL_INITIALIZER;
...
v___x_2_ = lean_box(0);
v___x_3_ = l_unsafeCast___redArg(v___x_2_);
return v___x_3_;
}
}
static lean_object* _init_l_Lean_Elab_Command_instInhabitedScope_default___closed__3(void){
_start:
{
uint8_t v___x_6_; lean_object* v___x_7_; lean_object* v___x_8_; lean_object* v___x_9_; lean_object* v___x_10_; lean_object* v___x_11_; lean_object* v___x_12_; 
v___x_6_ = 0;
v___x_7_ = ((lean_object*)(l_Lean_Elab_Command_instInhabitedScope_default___closed__2));
v___x_8_ = lean_box(0);
v___x_9_ = lean_obj_once(&l_Lean_Elab_Command_instInhabitedScope_default___closed__1, &l_Lean_Elab_Command_instInhabitedScope_default___closed__1_once, _init_l_Lean_Elab_Command_instInhabitedScope_default___closed__1);
v___x_10_ = l_Lean_Options_empty;
v___x_11_ = ((lean_object*)(l_Lean_Elab_Command_instInhabitedScope_default___closed__0));
v___x_12_ = lean_alloc_ctor(0, 10, 3);
lean_ctor_set(v___x_12_, 0, v___x_11_);
lean_ctor_set(v___x_12_, 1, v___x_10_);
lean_ctor_set(v___x_12_, 2, v___x_9_);
lean_ctor_set(v___x_12_, 3, v___x_8_);
lean_ctor_set(v___x_12_, 4, v___x_8_);
lean_ctor_set(v___x_12_, 5, v___x_7_);
lean_ctor_set(v___x_12_, 6, v___x_7_);
lean_ctor_set(v___x_12_, 7, v___x_8_);
lean_ctor_set(v___x_12_, 8, v___x_8_);
lean_ctor_set(v___x_12_, 9, v___x_8_);
lean_ctor_set_uint8(v___x_12_, sizeof(void*)*10, v___x_6_);
lean_ctor_set_uint8(v___x_12_, sizeof(void*)*10 + 1, v___x_6_);
lean_ctor_set_uint8(v___x_12_, sizeof(void*)*10 + 2, v___x_6_);
return v___x_12_;
}
}
...
v___x_13_ = lean_obj_once(&l_Lean_Elab_Command_instInhabitedScope_default___closed__3, &l_Lean_Elab_Command_instInhabitedScope_default___closed__3_once, _init_l_Lean_Elab_Command_instInhabitedScope_default___closed__3);
return v___x_13_;
}
}
...
v___x_14_ = l_Lean_Elab_Command_instInhabitedScope_default;
return v___x_14_;
}
}
