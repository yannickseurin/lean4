...
case 2:
{
lean_object* v_constName_324_; uint64_t v___x_325_; lean_object* v___x_326_; 
v_constName_324_ = lean_ctor_get(v_x_315_, 0);
v___x_325_ = 17ULL;
v___x_326_ = l_unsafeCast___redArg(v_constName_324_);
if (lean_obj_tag(v___x_326_) == 0)
{
uint64_t v___x_327_; 
v___x_327_ = lean_uint64_once(&l_Lean_HeadIndex_hash___closed__0, &l_Lean_HeadIndex_hash___closed__0_once, _init_l_Lean_HeadIndex_hash___closed__0);
return v___x_327_;
}
else
{
uint64_t v_hash_328_; uint64_t v___x_329_; 
v_hash_328_ = lean_ctor_get_uint64(v___x_326_, sizeof(void*)*2);
lean_dec(v___x_326_);
v___x_329_ = lean_uint64_mix_hash(v___x_325_, v_hash_328_);
return v___x_329_;
}
}
case 3:
{
lean_object* v_structName_330_; lean_object* v_idx_331_; uint64_t v___x_332_; uint64_t v___y_334_; lean_object* v___x_338_; 
v_structName_330_ = lean_ctor_get(v_x_315_, 0);
v_idx_331_ = lean_ctor_get(v_x_315_, 1);
v___x_332_ = 19ULL;
v___x_338_ = l_unsafeCast___redArg(v_structName_330_);
if (lean_obj_tag(v___x_338_) == 0)
{
uint64_t v___x_339_; 
v___x_339_ = 1723ULL;
v___y_334_ = v___x_339_;
goto v___jp_333_;
}
else
{
uint64_t v_hash_340_; 
v_hash_340_ = lean_ctor_get_uint64(v___x_338_, sizeof(void*)*2);
lean_dec(v___x_338_);
v___y_334_ = v_hash_340_;
goto v___jp_333_;
}
v___jp_333_:
{
uint64_t v___x_335_; uint64_t v___x_336_; uint64_t v___x_337_; 
v___x_335_ = lean_uint64_of_nat(v_idx_331_);
...
v_litVal_341_ = lean_ctor_get(v_x_315_, 0);
v___x_342_ = 23ULL;
