...
static const lean_string_object l_Lean_Compiler_LCNF_isDeclPublic___closed__2_value = {.m_header = {.m_rc = 0, .m_cs_sz = 0, .m_other = 0, .m_tag = 249}, .m_size = 7, .m_capacity = 7, .m_length = 6, .m_data = "_boxed"};
static const lean_object* l_Lean_Compiler_LCNF_isDeclPublic___closed__2 = (const lean_object*)&l_Lean_Compiler_LCNF_isDeclPublic___closed__2_value;
...
LEAN_EXPORT uint8_t l_Lean_Compiler_LCNF_isDeclPublic(lean_object* v_env_89_, lean_object* v_declName_90_){
_start:
{
lean_object* v___x_91_; uint8_t v_isModule_92_; 
v___x_91_ = l_Lean_Environment_header(v_env_89_);
v_isModule_92_ = lean_ctor_get_uint8(v___x_91_, sizeof(void*)*7 + 4);
...
{
lean_object* v___x_94_; lean_object* v___y_96_; 
v___x_94_ = ((lean_object*)(l_Lean_Compiler_LCNF_isDeclPublic___closed__0));
if (lean_obj_tag(v_declName_90_) == 1)
{
lean_object* v_pre_103_; lean_object* v_str_104_; lean_object* v___x_105_; uint8_t v___x_106_; 
v_pre_103_ = lean_ctor_get(v_declName_90_, 0);
v_str_104_ = lean_ctor_get(v_declName_90_, 1);
v___x_105_ = ((lean_object*)(l_Lean_Compiler_LCNF_isDeclPublic___closed__2));
v___x_106_ = lean_string_dec_eq(v_str_104_, v___x_105_);
if (v___x_106_ == 0)
{
v___y_96_ = v_declName_90_;
goto v___jp_95_;
}
else
{
v___y_96_ = v_pre_103_;
goto v___jp_95_;
}
}
else
...
v___jp_95_:
{
lean_object* v___x_97_; lean_object* v_asyncMode_98_; lean_object* v___x_99_; lean_object* v___x_100_; lean_object* v_snd_101_; uint8_t v___x_102_; 
v___x_97_ = l___private_Lean_Compiler_LCNF_PublicDeclsExt_0__Lean_Compiler_LCNF_publicDeclsExt;
v_asyncMode_98_ = lean_ctor_get(v___x_97_, 2);
v___x_99_ = lean_obj_once(&l_Lean_Compiler_LCNF_isDeclPublic___closed__1, &l_Lean_Compiler_LCNF_isDeclPublic___closed__1_once, _init_l_Lean_Compiler_LCNF_isDeclPublic___closed__1);
v___x_100_ = l___private_Lean_Environment_0__Lean_EnvExtension_getStateUnsafe___redArg(v___x_94_, v___x_97_, v_env_89_, v_asyncMode_98_, v___x_99_);
v_snd_101_ = lean_ctor_get(v___x_100_, 1);
lean_inc(v_snd_101_);
lean_dec(v___x_100_);
v___x_102_ = l_Lean_NameSet_contains(v_snd_101_, v___y_96_);
lean_dec(v_snd_101_);
return v___x_102_;
}
}
...
LEAN_EXPORT lean_object* l_Lean_Compiler_LCNF_isDeclPublic___boxed(lean_object* v_env_107_, lean_object* v_declName_108_){
_start:
{
uint8_t v_res_109_; lean_object* v_r_110_; 
v_res_109_ = l_Lean_Compiler_LCNF_isDeclPublic(v_env_107_, v_declName_108_);
lean_dec(v_declName_108_);
v_r_110_ = lean_box(v_res_109_);
return v_r_110_;
}
}
LEAN_EXPORT lean_object* l_Lean_Compiler_LCNF_setDeclPublic___lam__0(lean_object* v_declName_111_, lean_object* v_s_112_){
_start:
{
lean_object* v_fst_113_; lean_object* v_snd_114_; lean_object* v___x_116_; uint8_t v_isShared_117_; uint8_t v_isSharedCheck_123_; 
v_fst_113_ = lean_ctor_get(v_s_112_, 0);
v_snd_114_ = lean_ctor_get(v_s_112_, 1);
v_isSharedCheck_123_ = !lean_is_exclusive(v_s_112_);
...
lean_ctor_set(v___x_118_, 0, v_declName_111_);
lean_ctor_set(v___x_118_, 1, v_fst_113_);
v___x_119_ = l_Lean_NameSet_insert(v_snd_114_, v_declName_111_);
...
LEAN_EXPORT lean_object* l_Lean_Compiler_LCNF_setDeclPublic(lean_object* v_env_124_, lean_object* v_declName_125_){
_start:
{
uint8_t v___x_126_; 
lean_inc_ref(v_env_124_);
v___x_126_ = l_Lean_Compiler_LCNF_isDeclPublic(v_env_124_, v_declName_125_);
if (v___x_126_ == 0)
{
lean_object* v___x_127_; lean_object* v_asyncMode_128_; lean_object* v___f_129_; lean_object* v___x_130_; lean_object* v___x_131_; 
v___x_127_ = l___private_Lean_Compiler_LCNF_PublicDeclsExt_0__Lean_Compiler_LCNF_publicDeclsExt;
v_asyncMode_128_ = lean_ctor_get(v___x_127_, 2);
v___f_129_ = lean_alloc_closure((void*)(l_Lean_Compiler_LCNF_setDeclPublic___lam__0), 2, 1);
lean_closure_set(v___f_129_, 0, v_declName_125_);
v___x_130_ = lean_obj_once(&l_Lean_Compiler_LCNF_isDeclPublic___closed__1, &l_Lean_Compiler_LCNF_isDeclPublic___closed__1_once, _init_l_Lean_Compiler_LCNF_isDeclPublic___closed__1);
v___x_131_ = l_Lean_EnvExtension_modifyState___redArg(v___x_127_, v_env_124_, v___f_129_, v_asyncMode_128_, v___x_130_);
return v___x_131_;
}
else
{
